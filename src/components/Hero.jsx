...
//       <div className="container-custom grid lg:grid-cols-[1.2fr_0.8fr] gap-16 items-center relative z-10 pt-32 lg:pt-0">
...
//             className="relative group max-w-[5000px] mx-auto lg:mr-0"
//           >
//             {/* Image Frame */}
...
//             <div className="relative rounded-[1.5rem] overflow-hidden shadow-2xl shadow-black/50 aspect-[4/5] lg:aspect-auto">
//               <img
//                 src="/vijay.jpeg"
